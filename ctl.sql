CREATE TABLE users(
  ...
  sign_up_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMPT COMMENT '注册时间'
...
CREATE TABLE posts(
  postid INT AUTO_INCRREMENT PRIMARY KEY COMMENT '主题帖ID',
...
CREATE TABLE comments(
  commentid BIGINT AUTO_INCRREMENT PRIMARY KEY COMMENT '留言ID',
